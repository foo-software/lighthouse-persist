...
describe('getPageSpeedInsightsApiResult', () => {
  ...
  it('should call node-fetch correctly and return data', async () => {
    ...
    expect(fetch).toHaveBeenCalledWith(
      'https://pagespeedonline.googleapis.com/pagespeedonline/v5/runPagespeed?url=https://www.foo.software&category=ACCESSIBILITY&category=BEST_PRACTICES&category=PERFORMANCE&category=PWA&category=SEO&strategy=desktop&key=abc'
    );
