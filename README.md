...
See a full [example report here](https://s3.amazonaws.com/foo-software-html/lighthouse-report-example.html). This HTML report is generated by `lighthouse`. Lighthouse Persist extracts the content, populates an HTML file with it and uploads to your S3 account.
